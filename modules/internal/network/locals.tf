...
locals {
  ...
  vpc_id                      = local.has_vpc_id ? aws_vpc.tecton[0].id : var.vpc_id
  ...
  dynamodb_vpc_endpoint_id     = local.has_dynamodb_vpc_endpoint_id ? var.dynamodb_vpc_endpoint_id : aws_vpc_endpoint.dynamodb[0].id
  has_s3_vpc_endpoint_id       = var.s3_vpc_endpoint_id != null
  s3_vpc_endpoint_id           = local.has_s3_vpc_endpoint_id ? var.s3_vpc_endpoint_id : aws_vpc_endpoint.s3[0].id
