...
| Name | Type |
|------|------|
| [aws_iam_policy.common_spark](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
| [aws_iam_role_policy_attachment.common_spark](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="output_eks_cluster_role_name"></a> [eks\_cluster\_role\_name](#output\_eks\_cluster\_role\_name) | If deployment\_type is vpc, the name of the EKS cluster role. |
| <a name="output_eks_node_role_name"></a> [eks\_node\_role\_name](#output\_eks\_node\_role\_name) | If deployment\_type is vpc, the name of the EKS cluster node role. |
| <a name="output_eks_nodegroup_service_linked_role_arn"></a> [eks\_nodegroup\_service\_linked\_role\_arn](#output\_eks\_nodegroup\_service\_linked\_role\_arn) | n/a |
...
| <a name="output_spot_service_linked_role_arn"></a> [spot\_service\_linked\_role\_arn](#output\_spot\_service\_linked\_role\_arn) | n/a |
