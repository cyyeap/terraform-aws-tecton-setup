...
output "vpc_cidr_blocks" {
  description = "A map of the CIDR block(s) associated with the VPC."
...
output "public_subnet_route_table_ids" {
  description = "A map of the IDs of the public subnet route tables."
...
output "roles" {
  ...
  value = merge(
    module.common.roles,
    { cross_account_databricks_tecton_access_role_name = module.iam.cross_account_databricks_tecton_access_role_name }
  )
}
...
output "cross_account_databricks_tecton_access_role_external_id" {
  ...
  value       = module.iam.cross_account_databricks_tecton_access_role_external_id
}
