# Tecton Databricks SaaS Deployment Example

See [modules/databricks-saas](../../modules/databricks-saas) for more details.

This example assumes that the Databricks and Tecton deployments will be in the _same_ AWS account.
See [databricks-saas-cross-account](../databricks-saas-cross-account) if they are in different
accounts.
